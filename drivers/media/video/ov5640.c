...
static const struct regval_list ov5640_setting_30fps_PAL_720_576[] = {
	...
	{0x380d, 0x68}, {0x380e, 0x07}, {0x380f, 0xb0},
	...
	{0x3036, 0x54}, {0x3037, 0x13},
	ENDMARKER,
};


static const struct regval_list ov5640_vga_regs[] = {
// Faster PLL clocks to achieve 25 FPS
        {0x3034,0x1a},
        {0x3035,0x11},
        {0x3036,0x54},
        {0x3037,0x13},
...
/* 720X576 */
static const struct ov5640_win_size ov5640_win_576 = {
	.name     = "576",
	.width    =  720,
	.height   =  576,
	.win_regs = ov5640_setting_30fps_PAL_720_576,
	.frame_rate_array = frame_rate_vga,
};
